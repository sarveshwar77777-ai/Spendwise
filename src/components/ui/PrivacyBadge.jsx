  ...
  if (variant === 'banner') {
    return (
      <div className="bg-slate-100/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 rounded-xl p-3 text-xs text-slate-600 dark:text-slate-400 flex items-start gap-2.5">
        ...
        <div>
          <span className="font-semibold text-slate-700 dark:text-slate-300">Privacy Notice:</span> Your prototype expense data is stored locally in this browser. No financial credentials or personal information are collected or uploaded.
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gradient-to-r from-brand-50 to-indigo-50 dark:from-slate-900 dark:to-slate-900/90 border border-brand-100 dark:border-slate-800 rounded-2xl p-4 sm:p-5 text-sm text-slate-700 dark:text-slate-300">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h4 className="font-semibold text-slate-900 dark:text-slate-100 text-sm">About this Prototype</h4>
          <p className="mt-1 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            SpendWise is a student-focused expense management prototype created as part of a Design Thinking project (<em>Project Better Tomorrow – Pathway B: Fresh Discovery Track</em>). The prototype will be refined based on feedback from real student users.
          </p>
        </div>
      </div>
    </div>
